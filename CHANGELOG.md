...
- D2 多轮对话稳定性测试（9 组 3-10 轮场景）

## [0.2.2] — 2026-06-06

### D1 评估集扩展：48 → 66 条（+18 条）

基于 [SoulChatCorpus](https://www.modelscope.cn/datasets/YIRONGCHEN/SoulChatCorpus/)（258K+ 轮中文心理咨询对话，12 主题）的「盲区地图」分析，识别出原 D1 评估集在 5 个主题上的覆盖空白，针对性新增 18 条 good/bad 黄金对照案例。
