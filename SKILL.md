...
- 共同要素（Common Factors）理论：心理治疗效果来源的方差分解（Norcross & Lambert, 2019 第三版）为——患者自身因素约 30%、治疗关系约 15%、具体疗法技术约 10%、治疗师因素约 7%。这意味着关系因素的贡献显著超过具体流派技术。Cuijpers et al. (2019) 进一步指出，目前没有任何共同要素或特定技术达到"经验验证的工作机制"的严格因果证据标准。MindMirror 采纳共同要素框架是 pragmatic 的设计选择，而非声称其已获因果验证。
